...
import type { Dossier, Session, TabId } from "./lib/types";
...
export default function App() {
  ...
  const tabs: TabDef[] = [
    { id: "research", label: "Research", panel: <ResearchScreen dossiers={dossiers} onDossiersChange={handleDossiers} /> },
    {
      id: "rehearse",
      label: "Rehearse",
      panel: (
    ...
    { id: "relive", label: "Relive", panel: <ReliveScreen sessions={sessions} /> },
  ];
